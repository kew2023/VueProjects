<template>
    <div class='main__container'>
        ...
        <div class="main__title" @click="() => { reviews.length = 0; countReviews = 0 }">Вы действительно хотетите выйти из
            профиля?
        </div>
        <div class="list__el">
            <router-link to="/"> <button class="el">Да</button></router-link>
            <router-link to="Ads"><button class="el">Нет</button></router-link>
        </div>
    </div>
</template>
